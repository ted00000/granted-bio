...
export async function GET(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    // Linkage tables store project_number in core form. Normalize to core
    // form on both sides of the membership check so projects stored as
    // full form (e.g. "5R01CA214679-04") match linkage rows stored as
    // core ("R01CA214679").
