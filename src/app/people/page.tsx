      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 pt-[max(1rem,env(safe-area-inset-top))] pb-4 sm:px-6">
          <div className="flex items-center justify-between">
            ...
            <Link href="/chat?persona=bd" className="text-sm text-[#E07A5F] hover:text-[#C96A4F] font-medium">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 sm:px-6">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 text-center">
            <Users className="w-12 h-12 text-gray-300 mx-auto mb-4" strokeWidth={1.5} />
            <h2 className="text-lg font-medium text-gray-900 mb-2">No saved people yet</h2>
