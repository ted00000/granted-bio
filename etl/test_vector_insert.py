"""
Test different vector insertion formats to find what works with Supabase pgvector.
"""
...
print("TEST 1: Pass list directly")
try:
...
# Test 2: Convert to string with str()
print("TEST 2: Use str(list)")
try:
