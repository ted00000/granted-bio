"""
Test INSERT vs UPDATE for vector insertion to see if there's a difference.
"""
...
print("=" * 60)
print("TEST: Using UPDATE with list")
try:
    supabase.table('projects').update({
    ...
    print(f"  Stored length: {len(stored) if stored else 'NULL'}")
